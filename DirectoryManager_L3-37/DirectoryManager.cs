...
namespace DirManager
{
    ...
    {  // From GitHubGist: https://gist.github.com/PaulSchrum/4fb6015d46d79c06b08acb7f1bb00c53
        ...
        public DirectoryManager(DirectoryManager other)
        {
    ...
    public class DirectoryNode : DirectoryManager
    {
        ...
        public IReadOnlyList<string> FindAll(string searchString)
        {
    ...
    public class FileNode : DirectoryManager
    {
